...
Bureaucrat::Bureaucrat(int notee) : name("default with note")
{
    ...
    note = notee;
    std::cout << "constructor Bureaucrat with a note in arg" << std::endl;
}
...
std::string Bureaucrat::GradeTooHighException() const { return "too high"; }

std::string Bureaucrat::GradeTooLowException() const { return "too low"; }
